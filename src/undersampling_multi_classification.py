...
class Args(Tap):
	...
	# -> 3 categories: 'obscene', 'discriminatory', 'corporate'
	dataset_path: str = "data/toxicity_ver2_downsampling.jsonl"
...
def main(args):
	...
	# 2.3 k-fold cross-validation settings
	k_folds = 5
	kf = KFold(n_splits=k_folds, shuffle=True, random_state=args.datasplit_seed)
